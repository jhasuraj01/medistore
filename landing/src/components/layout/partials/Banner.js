          ...
          <div className="banner-inner text-xxs">
            <div className='banner-container'>
              <a
                ...
                <span className="banner-hide-on-sm">Contact </span>
                Sales
              </a>
              <span className="banner-separator">or</span>
              <a className="banner-link banner-link-green" href="https://cruip.com/open-pro/" target="_blank" rel="noopener noreferrer">Check Live Demo</a></div>
